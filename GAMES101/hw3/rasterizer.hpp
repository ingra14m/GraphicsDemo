...
namespace rst {
    ...
    private:
        ...
        void rasterize_triangle(const Triangle &t, const std::array<Eigen::Vector3f, 3> &world_pos, bool use_origin = true);
    ...
    private:
        ...
        std::optional<Texture> texture;  // 可以理解为就是用optional包了一下，实际上与Texture直接用没啥区别
